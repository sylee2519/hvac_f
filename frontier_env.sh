...
source /lustre/orion/proj-shared/gen008/hsoon_venv/bin/activate
...
export MY_JOBID=0
export HVAC_LOG_DIR=/lustre/orion/proj-shared/gen008/seoyeong/hvac_f/build/src
export HVAC_DATA_DIR=/lustre/orion/proj-shared/gen008/seoyeong/hvac_f/build/tests
